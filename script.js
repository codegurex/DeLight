...
const menuCategories = [
  {
    ...
    items: [
      ...
      { 
        ...
        price: 2.00, 
        image: "images/delightfantasia.jpg",
        isBuilder: true,
        selectionGroups: [
      ...
      { 
        ...
        price: 2.50, 
        image: "images/parfaitdeyogurtgriego.jpg"
      },
      ...
      { 
        ...
        price: 2.25, 
        image: "images/armatudelight.jpg",
        isBuilder: true,
        selectionGroups: [
          { name: "Yogurt", options: ["Yogurt griego natural", "Yogurt griego vainilla", "Kefir"], maxSelect: 1, required: true },
          { name: "Jalea", options: ["Maracuya", "Fresa", "Kiwi", "Durazno", "Mora", "Machat", "Manjar", "Cafe", "Chocolate", "Pina"], maxSelect: 1, required: true },
      ...
      { 
        ...
        price: 1.90, 
        image: "images/manichococrocante.jpg"  
      },
      ...
      { 
        ...
        price: 2.99, 
        image: "images/delightenergy.png"
      },
      ...
      { 
        ...
        price: 2.25, 
        image: "images/delighttropical.png"
      },
      ...
      { 
        ...
        price: 2.50, 
        image: "images/delightpremiun.png"
      },
    ]
  },
  {
...
function getTotal() {
  var sub = getSubtotal();
  return deliveryType === "delivery" ? sub + DELIVERY_FEE : sub;
}
...
function renderCart() {
  ...
  if (deliveryType === "delivery") {
    totalHtml += '<div class="cart-delivery-fee"><span>Envio a domicilio</span><span class="fee">+$' + DELIVERY_FEE.toFixed(2) + '</span></div>';
  }
...
function sendToWhatsApp() {
  ...
  if (deliveryType === "delivery") {
    msg += "*Envio a domicilio: +$" + DELIVERY_FEE.toFixed(2) + "*\n";
  }
